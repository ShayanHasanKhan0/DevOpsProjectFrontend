...
@Component({
  selector: 'app-viewstatstab',
  templateUrl: './viewstatstab.component.html',
  styleUrls: ['./viewstatstab.component.css']
})
export class ViewstatstabComponent implements OnInit {
